...
<div class="notes-page">
  <ul class="notes-list">
    ...
    <li class="notes-entry">
      <h2><a href="https://qspace.fqxi.org/articles/284/risky-business-how-science-plays-things-too-safe" target="_blank" rel="noopener">Risk and Scientific Work</a></h2>
      <p>George Musser on why science often praises risk while rewarding safety.</p>
    </li>
    <li class="notes-entry">
      <h2><a href="https://ckarchive.com/b/mvu7h5hqdzmd7uv5oo45wirxvvqq3i3hw9v2e" target="_blank" rel="noopener">Reality Keeps Unfolding</a></h2>
      <p>A short reflection from <em>The Imperfectionist</em> on openness, incompleteness, and final interpretations.</p>
    </li>
    <li class="notes-entry">
